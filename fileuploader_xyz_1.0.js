...
qq.FileUploaderBasic.prototype = {
    ...
    _createUploadHandler: function(){
        ...
        if(this._options.uploadType == 'xhr'){
        ...
        var handler = new qq[handlerClass]({
            ...
            fileLimit: this._options.fileLimit,
            uploadType: this._options.uploadType,
            ...
            onError: function(id, fileName, e){
                self._options.onError(id, fileName, e);
            }
        });
    ...
    _validateFile: function(file){
        var name, size = qq.getFileSize(file);
...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        /*fileTemplate: '<li style="display:none;">' +
                ...
                '<span style="display:none;" class="qq-upload-failed-text">Failed</span>' +
            '</li>',  */      
...
qq.extend(qq.FileUploader.prototype, {
    ...
    _setupDragDrop: function(){
        ...
        qq.attach(document, 'dragenter', function(e){     
            ...
            dropArea.style.display = 'none'; // drop功能先不要了            
        });                 
    ...
    _onProgress: function(id, fileName, loaded, total){
        ...
        size.style.display = 'none';// size也先不表示了
...
qq.extend(qq.UploadHandlerForm.prototype, {
    ...
    _upload: function(id, params){                        
        ...
        if(self._options.multiple){
            var inputName = self._options.inputName;
            
            var fileLen = 1;
            if(form[inputName] != undefined && form[inputName].files != undefined){
                fileLen = form[inputName].files.length;
            }
    ...
    _getIframeContentJSON: function(iframe){
        ...
        var bodyIn = doc.body.innerHTML;
        bodyIn =bodyIn.replace(/<\/?.+?>/g,"");
        try {
            response = eval("(" + bodyIn + ")");
        } catch(err){
            response = {};
        }        
    ...
    _createIframe: function(id){
        ...
        var iframe = qq.toElement('<iframe src="" name="' + id + '" />');
    ...
    _createForm: function(iframe, params){
        ...
        var actionPlus="";
        if (typeof(picactionPlus)!='undefined'){
        	actionPlus = picactionPlus;
        }
